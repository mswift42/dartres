...
import 'projectinfomodel.dart' show ProjectInfo, themecreatorinfo, beebsterinfo, metalheadinfo;
...
class SingleProject extends Observable {
  ...
  SingleProject(
      this.projecttitle, this.githuburl, this.shortdescription, this.titleimg, this.projinfo);
}
